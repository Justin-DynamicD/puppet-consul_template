...
#
# [*purge_config_dir*]
#   Purge config files no longer generated by Puppet.  Defaults to false
#
# [*vault_enabled*]
...
#
# [*bin_dir*]
#   Path to a directory to store the executable. Defaults to '/etc/consul-template'
#
# [*link_dir*]
#   Path to a directory to link exececutable to. Defaults to '/usr/local/bin'
#
# [*config_dir*]
#   Path to a directory to create to hold the config.cfg. Defaults to '/etc/consul-template/config'
#
# [*template_dir*]
#   Path to a directory to create to hold templates for consumption. Defaults to '/etc/consul-template/templates'
#
# [*user*]
...
class consul_template (
  ...
  $bin_dir               = '/etc/consul-template',
  $config_dir            = '/etc/consul-template/config',
